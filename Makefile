...
$(addprefix utils/map/, ft_put_walls.c ft_make_map.c ft_read_map.c ft_exit_map.c) \
...
$(addprefix utils/movements/, ft_key_input.c ft_move_player.c ft_collect_item.c)
