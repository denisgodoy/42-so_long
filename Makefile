...
$(addprefix utils/map/, ft_put_walls.c ft_make_map.c ft_read_map.c ft_parse_line.c) \
$(addprefix utils/validations/, ft_check_args.c ft_map_format.c ft_valid_map.c \
ft_validate_map_str.c ft_error_handler.c) $(addprefix utils/sprites/, ft_img_init.c) \
$(addprefix utils/movements/, ft_key_input.c)
